...
public class RoomRepository {
    ...
    private static final String ROOMS_DIR = DATA_DIR + "rooms/";      // data/rooms/
    private static final String ROOMS_FILE = ROOMS_DIR + "rooms.dat";  // data/rooms.dat
    ...
    public RoomRepository() {
        ...
        // Ensure rooms subdirectory exists (for favorites)
        new File(ROOMS_DIR).mkdirs();


        System.out.println("[ROOM REPO] Data directory: " + new File(DATA_DIR).getAbsolutePath());
    }
